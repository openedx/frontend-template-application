...
const createSubDomainCompetencyTypeItem = () => ({
...
const SubDomainTab = ({
  ...
  const handleAddCompetencyType = () => {
    onChangeCompetencyTypes([...competencyTypes, createSubDomainCompetencyTypeItem()]);
  };
          ...
          <div key={item.id} className="framework-builder__domain-item">
            <div className="framework-builder__domain-item-head">
              <div className="framework-builder__domain-item-title-wrap">
                ...
                <label className="framework-builder__label" htmlFor={`sub-domain-competency-type-${item.id}`}>
                  {labels.competencyType}
                </label>
                <input
                  id={`sub-domain-competency-type-${item.id}`}
            ...
            <div className="framework-builder__field">
              <label className="framework-builder__label">{labels.subDomains}</label>
              <div className="framework-builder__domain-input-row">
                <div className="framework-builder__domain-input-main">
                  <MultiSelectInput
                    options={subDomainOptions}
                    selectedValues={item.subDomains}
                    onChange={next => updateCompetencyType(item.id, 'subDomains', next)}
                    disabled={!canEdit}
                  />
                </div>
                <button
                  ...
                  onClick={() => setIsAddSubDomainOpen(true)}
                  disabled={!canEdit}
                  title={labels.addNewSubDomain}
                >
...
export { createSubDomainCompetencyTypeItem };
