...
const SearnTrainingProviderCatalog = () => {
  ...
  return (
    <section className="searn-training-catalog-page">
      <button type="button" className="provider-page__back" onClick={() => navigate(`/admin/searn-training-catalog/providers/${providerSlug}`)}>
        <FontAwesomeIcon icon={faArrowLeft} />
        Back to Provider
      </button>
              ...
              <tbody>
                {pageRows.map(row => (
                  ...
                  >
                    ...
                    <td className="searn-training-catalog-page__td">{row.mode}</td>
                    <td className="searn-training-catalog-page__td">{providerName}</td>
                    <td className="searn-training-catalog-page__td">
                      <button
                        type="button"
                        className="searn-training-catalog-page__rating-button"
                        onClick={(e) => { e.stopPropagation(); navigate(`/admin/searn-training-catalog/${row.id}/feedback`); }}
                    ...
                    <td className="searn-training-catalog-page__td" style={{ fontWeight: 600 }}>{row.cost}</td>
                  </tr>
                ))}
              </tbody>
            </table>
...
export default SearnTrainingProviderCatalog;
