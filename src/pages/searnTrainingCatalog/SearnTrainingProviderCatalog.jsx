...
import { findTrainingProviderOptionBySlug, FILTER_ALL } from '../../api/searnTrainingCatalog/trainingsCatalogOptionsUtils';
...
const SearnTrainingProviderCatalog = () => {
  ...
  if (!hasDisplayValue(providerFilterId) || providerFilterId === FILTER_ALL) {
    return (
      <section className="searn-training-catalog-page">
        <button type="button" className="provider-page__back" onClick={() => navigate(ADMIN_PATHS.trainingCatalogProvider(provider.slug))}>
  ...
  return (
    <section className="searn-training-catalog-page">
      ...
      <SearnTrainingCatalogListSection
