...
import '../searnTrainingCatalog/SearnTrainingProvider.scss';
...
const NraSpecificTrainingProvider = () => {
  ...
  const handleViewCatalog = () => {
    if (provider?.slug) {
      navigate(ADMIN_PATHS.nraSpecificTrainingCatalogProviderCatalog(provider.slug));
    }
  };
...
export default NraSpecificTrainingProvider;
